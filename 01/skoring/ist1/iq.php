...
function getIQ($sw) {
    ...
    // Memeriksa apakah nilai SW ada dalam tabel
    if (array_key_exists($sw, $sw_iq_map)) {
        return $sw_iq_map[$sw];
    } else {
        return "Nilai SW tidak ditemukan dalam tabel.";
    }
}

// Contoh penggunaan fungsi
// $sw = 140; // Ubah nilai SW sesuai keinginan
// echo "Nilai IQ untuk SW " . $sw . " adalah: " . getIQ($sw);
?>
