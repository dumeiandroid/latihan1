const questionsData = [
    {
        "question": "1. Kalau ada orang yang meminta petunjuk jalan, biasanya saya akan....",
        "options": {
    ...
    {
        "question": "2. Saya paling suka permainan...",
        "options": {
            "A": "Kata bergambar",
            "B": "Acak Kata",
            "C": "Pantomin"
    ...
    {
        "question": "3. Saya ingin sekali menonton dalam bioskop karena...",
        "options": {
            "A": "Melihat cover iklan yang menarik",
            "B": "Membaca sinopsis cerita",
            "C": "Menuntun potongan film"
        }
    },
    {
        "question": "4. Saya punya guru favorit saat mengajar, ia selalu menggunakan...",
        "options": {
            "A": "Ceramah, diskusi, dan debat",
            "B": "Diagram, bagan, alur, dan slide",
            "C": "Tutorial, Uji coba, dan praktik"
        }
    },
    {
        "question": "5. Ketika bicara, biasanya saya paling suka....",
        "options": {
    ...
    {
        "question": "6. Sebelum mengerjakan sesuatu, saya biasanya....",
        "options": {
    ...
    {
        "question": "7. Ketika lupa sesuatu, biasanya saya....",
        "options": {
    ...
    {
        "question": "8. Hal yang paling bisa saya ingat dari seseorang adalah....",
        "options": {
    ...
    {
        "question": "9. Saat berkomunikasi, saya suka kalau ...",
        "options": {
    ...
    {
        "question": "10. Kemampuan yang saya bisa dan paling saya sukai adalah...",
        "options": {
    ...
    {
        "question": "11. Ketika santai, saya biasanya...",
        "options": {
    ...
    {
        "question": "12. Saat marah, saya biasanya...",
        "options": {
    ...
    {
        "question": "13. Konsentrasi saya terganggu jika ...",
        "options": {
    ...
    {
        "question": "14. Saat belajar, saya biasanya ....",
        "options": {
    ...
    {
        "question": "15. Saat membaca sesuatu, saya biasanya...",
        "options": {
            "A": "Menyukai bacaan yang bercerita tentang detil peristiwa",
            "B": "Menyukai bacaan yang memiliki banyak percakapan antartokoh",
